...
function createtime() {
    ...
    var e = new Date("03/06/2024 14:51:00"),
        t = Math.trunc(234e8 + (now - e) / 1e3 * 17),
        a = (t / 1496e5).toFixed(6),
        o = new Date("03/06/2025 14:51:00"),
